...
interface RepositoryModule {
    @Binds
    fun bindsMatrixRepository(matrixRepository: MatrixRepositoryImpl): MatrixRepository
}

@Module
class ViewModelModule {
    @Provides
    fun provideMatrixViewModelFactory(viewModelStore: ViewModelStore, repository: MatrixRepository): ViewModelProvider.Factory = MatrixViewModelFactory(viewModelStore, repository)
}